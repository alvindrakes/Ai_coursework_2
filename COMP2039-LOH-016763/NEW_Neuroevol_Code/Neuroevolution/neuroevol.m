...
% changed the mutation prob TEST  ORI is 0.5
...
memParams.doSA = true; % for SA test

memParams.crossOverType = 1;
...
%TESTING INDV learning 
    memParams.ilType = 4; % see doIndivLearn1 for the meaning of different types
